...
1911년 1월부터 1922년 5월까지 『천도교회월보(天道敎會月報)』에 실린 이돈화의 글 166편이다.
...
⚠️ **수가 두 번 늘었다.** 오래 86편이었다. 2026-08-12에 **夜雷 명의 39편이 통째로 빠져
있었음**이 드러나 목록을 다시 세웠고, 2026-08-13에 국립중앙도서관에 없던 **9편을 영인본에서
촬영해** 채웠다. 옛 문서에 86편으로 적힌 대목이 있으면 그 시점의 기록이다.

**이 자료는 미완이다.** 내역은 **정본 10 · 초벌 147 · 영인·단일 8 · 본문 없음 1**이다.
열 편만 사람이 전문을 원본과 대조했고, 대부분은 두 엔진이 갈린 자리를 안은 초벌이며,
한 편(C10)은 아직 전사하지 않았다. 그런데도 전부 내놓는다.
**대신 어디가 어느 등급인지를 글자마다 표시했다.**

📌 **영인본에서 얻은 편은 9편이다.** 그 가운데 `158_我觀`은 국중 스캔 2면이 함께 있어
위 집계에서 초벌로 잡힌다. 이 9편은 **대조 엔진이 없다** — [`TRUST.md`](TRUST.md) 「영인·단일」.
...
> ⚠️ 아래는 **86편 시절의 실측**이다. 그 뒤 夜雷 명의 39편의 누락이 드러나고 영인본 9편이 더해져 현재는 **166편**(정본 10 · 초벌 147 · 영인·단일 8 · 본문 없음 1)이다. 현재 수치는 이 문서 앞머리와 [`TRUST.md`](TRUST.md)·[`CATALOG.md`](CATALOG.md)를 본다.
