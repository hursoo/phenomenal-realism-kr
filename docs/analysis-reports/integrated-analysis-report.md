...
앞서 확인한 111개 참조쌍은 이돈화가 이노우에의 **논리**를 차용했음을 보여준다. 그러나 허수(2015)가 제기한 '소거' 현상—이노우에의 이름과 저서가 명시되지 않는 현상—은 단순히 출처 표기의 누락인가, 아니면 더 체계적인 전략인가? 이를 검증하기 위해 본 연구는 '哲學'이라는 단어에 주목한다.

'哲學'은 이노우에 텍스트의 제목이자 핵심 정체성을 나타내는 기표이다. 만약 이돈화가 이노우에의 철학적 논리를 가져오면서 '哲學'이라는 단어 자체를 의도적으로 회피했다면, 이는 단순한 누락이 아니라 **기표의 소거**라는 체계적 전략의 증거가 된다.
