...
본 연구는 **문단(paragraph)**을 분석의 기본 단위로 설정하였다. 문장 단위는 우연적 일치가 많고, 장 단위는 해상도가 너무 낮다. 문단은 하나의 논점을 전개하는 의미 단위로서, 참조 관계를 포착하기에 적절한 크기이다.
...
임계값 0.1은 평균의 **20배**, 표준편차 기준 **μ + 7.3σ**에 해당하는 값이다. 정규분포를 가정할 경우 μ+7σ를 초과할 확률은 사실상 0에 가깝다. 실제로 228,490개 중 135개(0.06%)만이 이 기준을 충족하여, 이들이 **통계적 이상치(outlier)**임을 확인할 수 있다.
...
참조쌍은 **C03(人乃天과 眞理)**과 **C06(인내천의 雜感)**에 집중되어 있으며, 두 장이 전체의 **97%**를 차지한다.
...
| C13 (기독교와 유교) | C06 (인내천의 雜感) | 31개 | 儒基 비교 프레임 |
| C14 (불교와 기독교) | C06 (인내천의 雜感) | 20개 | 佛基 비교 프레임 |
...
228,490개 문단 쌍을 전수 비교하여 111개 유효 참조쌍을 확정하였다. 참조쌍은 C03(人乃天과 眞理)과 C06(인내천의 雜感)에 집중되어 있으며(97%), 특히 C03-S04의 I02(實在)와 I05(意識), C06-S06의 儒基/佛基 비교 구간에 밀집되어 있다. 이돈화는 이노우에의 현상즉실재론, 의식론, 비교종교학적 프레임을 집약적으로 차용하였으나, 일본 국체론·신도론 등 일본 중심적 이데올로기는 철저히 배제하였다.
