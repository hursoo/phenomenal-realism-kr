...
이돈화의 차용은 **세 층위**에서 작동한다:

| 층위 | 내용 | 예시 |
|------|------|------|
| **1. 개념** | 핵심 용어의 직접 전용 | 唯物論/唯心論, 實在, 神人敎/神政敎 |
| **2. 논증 구조** | 변증법적 전개 패턴 | 正(唯物)→反(唯心)→合(實在) |
| **3. 비교 틀** | 종교 비교의 항목 체계 | 甲-己(己) 또는 甲-辛 항목 구성 |
...
| 이노우에 | 이돈화 | 전복 내용 |
|----------|--------|-----------|
| 실재론의 결론: 철학적 절대자 | 실재론의 결론: **한울님** | 철학→종교 |
| 일본 국민도덕 정당화 | **식민지 주체성** 확보 | 제국→탈식민 |
| 기독교의 우위 암시 | **인내천의 종합·초월** | 서구 종교→동학 |

### 7.3 '이데올로기적 모듈'로서의 현상즉실재론

이노우에의 현상즉실재론은 **맥락 이식 가능한 모듈**로 기능한다:
- 형식적 틀(변증법 구조, 비교 항목)은 유지
- 내용(결론, 가치 판단)은 이돈화의 목적에 맞게 대체

이는 허수(2025)가 제시한 '재귀적 시간화' 개념과 연결된다—식민지 지식인이 제국의 지식을 전유하여 탈식민적 논리를 구축하는 전략.
...
2. 참조쌍은 **C03(철학·생명론)**과 **C06(비교종교론)**에 집중 분포
3. 이돈화는 '보편적 지식'(생명과학, 의식론)은 수용하고 '지역적 맥락'(일본 학계 논쟁)은 필터링
4. 비교종교 프레임워크는 **골격 차용 + 독자적 항목 추가**의 패턴을 보임
5. 차용된 틀의 결론은 **천도교 교리로 전환**되어 '전복'됨
