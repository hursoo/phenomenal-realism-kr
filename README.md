...
**월보는 원본 지면 스캔 800장(160편)이 함께 있다** —
`data/5_magazine_sources/wolbo/source_pages/`. 국립중앙도서관 스캔이며, 판독이 갈린 자리에서
어느 쪽이 맞는지 남이 판정할 수 있다.

⚠️ **다만 월보 전사는 대부분 미검수 초벌이다** — 166편의 내역은 **정본 9 · 초벌 148 · 영인·단일 8 · 본문 없음 1**이다.
전문 대조를 마친 아홉 편(정본)이고,
...
📌 **그래서 166편을 미완인 채로 쓸 수 있게 내놓았다**(2026-08-12, 2026-08-13 증보). 완성될 때까지 기다리면
아무도 쓰지 못하므로, **어디가 어느 등급인지를 글자마다 표시**하는 쪽을 택했다.

| | |
|---|---|
| [`reading/`](data/5_magazine_sources/wolbo/reading/) | **읽을 수 있는 본문 166편** — 마커를 해소하되 〔규칙〕〔대장〕〔C〕〔G〕〔?…〕〔확인〕으로 해소 방식을 표시. 영인본에서만 얻은 9편은 〔영인·단일〕 |
...
📌 **2026-08-13 증보 — 국립중앙도서관에 없던 아홉 편.** 소장 『天道敎會月報 影印本』
(天道敎中央總部, 1980)에서 지면을 찾아 촬영하고 단(段)으로 잘라 판독했다. 디지털로는
갈 데가 없던 편들이며, 이로써 1911~1922년 이돈화 글의 사정권이 실질적으로 닫혔다
(남은 한 편 통134는 영인본에도 지면이 없다). **다만 대조 엔진이 없어 등급이 다르다** —
[`TRUST.md`](data/5_magazine_sources/wolbo/TRUST.md) 「영인·단일」 참조.

초벌본의 마커는 **34,146**이고, 기사 경계 밖(앞 글의 꼬리·다음 글의 머리·면주·캡션)을
걷어낸 뒤 읽는 판에 남는 것이 **31,885**다. **그 가운데 70.5%가 기계가 한쪽을 고른
자리**이며 5.7%는 아무도 고르지 못한 대분기다. 그 비율을 감추지 않는 것이 이 공개의 요건이다.

⚠️ **『천도교회월보』 166편 가운데 한 편(통권 18, 1912년 1월)은 본문이 없다.** 옛한글 전사
실험의 표본 헤더만 들어 있어 **전수가 실제로 훑은 것은 165편**이다. 빠진 한 편은 원본 스캔을
직접 판독해 확인했으며 그 이미지가 `data/1_raw_data/wolbo_18/`에 있다.

✅ **1916년의 공백이 메워졌다**(2026-08-13). 1916년 이돈화의 글은 통권 77 「人生」
한 편뿐인데(1916-12, 講演 19~23쪽) 국립중앙도서관에 없어 오래 비어 있었다. 영인본에서
찾아 판독했다 — `160_人生`. **이제 1911~1922년에 빈 해가 없다.**
...
🔴 **월보 코퍼스는 초벌 위에 서 있다.** 148편은 엔진이 갈린 자리가 편당 수백 곳 남은 채로 들어가
