...
| **잡지** | 『개벽』 · 『천도교회월보』 | **74편 · 86편** | **개벽은 디지털 원문 · 월보는 3엔진 합의** |
...
| **『개벽』** | **없음** — 국사편찬위 디지털 원문 | — |
| **『천도교회월보』** | **3엔진 합의** — Claude Opus(주) · Gemini 2.5 Pro(보강) · PaddleOCR(검증) | 차이 영역마다 사람이 중재 |
| 분석 스크립트 | Claude Code | 요구 명세·검수 |

곧 **『개벽』에는 판독 위험이 없고, 월보는 세 엔진이 서로를 견제했으며, 두 단행본은 단일 엔진에
여러 판 교정을 얹었다.** 위험의 형태가 셋 다 다르다.
