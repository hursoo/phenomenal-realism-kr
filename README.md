...
| 『천도교회월보』 | 86 | 1911. 1. ~ 1922. 5. | 지면 판독 (3엔진 합의) | `MA_YD_10-20_WB.xlsx` |
...
| **『개벽』** | **없음** — 국사편찬위 디지털 원문 | — |
| **『천도교회월보』** | **3엔진 합의** — Claude Opus(주) · Gemini 2.5 Pro(보강) · PaddleOCR(검증). 영인본 9편은 **단일 엔진**(Claude Opus 5) | ⚠️ **166편 중 9편만 전문 대조** |
