...
IDENTIFIED = {
    '_편외/편외_我觀苦樂論_1913-07': dict(
        ...
        추정호='통권 36 (1913-07-15) · 19~23쪽 가운데 19~20쪽만',
        확인='2026-08-12 Soo가 지면을 열어 확인 — 제목은 「論」(NL의 「說」은 오류), '
             '필자 李敦化, 19쪽은 제목만, 20쪽 하단이 종결되지 않고 이어진다',
        메모='🔴 **지면 일부만 있다.** 실제 범위는 19~23쪽 다섯 면인데(다음 글이 24쪽) '
             '우리가 가진 것은 두 장뿐이다. 가진 만큼만 부분 전사했다(158_我觀_1913-07, '
             'partial=Y). **이 편의 텍스트로 「없다」를 말할 수 없다.** '
             '20쪽 하단의 「今古俚海(第五)」는 다른 란의 글이 함께 앉은 것이다'),
    '_편외/편외_偉大한心의世界_1918-04': dict(
        cnts='CNTS-00048037679', 판정='편외', 제목='偉大ᄒᆞᆫ 心의 世界', 필자='李敦化', 게재='敎理部', 쪽='16',
        추정호='제93호 (1918-04-15) · 16~20쪽',
        확인='지면 제목·필자·란·쪽수를 직접 확인. **2026-08-12 Soo가 전문을 열어 '
             '16~20쪽 완결임을 확인**했다 — 앞뒤로 더 붙거나 덜 붙을 여지가 없다',
        메모='🔴 목차와 지면이 어긋난 자리다. 영인본 목차는 통93 敎理部에 '
             '「偉大ᄒᆞᆫ 心의 世界 / 劉載豊 / 15쪽」과 「神平河善論 / 李敦化 / 16쪽」을 '
             '나란히 실었으나, 지면 16~20쪽에 있는 것은 **李敦化의 「偉大ᄒᆞᆫ 心의 世界」** '
             '하나뿐이다. 곧 목차는 이 글의 필자와 쪽을 틀리게 적었고, 「神平河善論」은 '
             '그 자리에 없다. 통94에 「偉大ᄒᆞᆫ 心의 世界 其二」(滄海居士)가 있는 것도 '
             '其一이 이돈화임을 받친다'),
