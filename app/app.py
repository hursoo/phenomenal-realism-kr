...
if selection == "Ⅰ. 머리말":
    ...
    <div style="text-align: center;">
        ...
        <h3 style="font-size: 20px; color: #555; margin-top: 0px;">
            『철학과 종교』에 대한 이돈화의 취사선택을 중심으로
        </h3>
        <p style="color: gray; font-size: 14px; margin-top: 15px;">2026-01-24</p>
    </div>
    """, unsafe_allow_html=True)
